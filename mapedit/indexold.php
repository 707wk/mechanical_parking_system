...
switch(@$_GET['do']){
	...
	case 'getmkinfo':
		// if($dbh->query("select * from t_garageinfo where name=$_GET[mkid]")->rowCount()==0){
			// $dbh->exec("INSERT INTO `t_garageinfo` (`name`, `rows`, `cols`, `speedrows`, `speedcols`,  `map_queue`) VALUES
// ('$_GET[mkid]', 5, 4, 2.000, 1.100, '131073 2 65539 4 65541 65542 65543 8 65545 65546 65547 12 65549 65550 15 16 65553 18 19 20 ');");
		// }
